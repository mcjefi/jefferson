...
bool Player::checkAutoLoot(int itemId) const {
    // TODO: Implementar lógica real de autoloot
    return false;
}

bool Player::isMoneyAutoLoot() const {
    // TODO: Implementar lógica real de autoloot para dinheiro
    return false;
}
